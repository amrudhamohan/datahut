...
for product in product_urllists:
    ...
    product_price = product_soup.find('div', class_='_30jeq3 _16Jk6d') 
    product_rating = product_soup.find('div', class_='_3LWZlK') 
    product_mrpprice = product_soup.find('div', class_='_3I9_wc _2p6lqe') 
